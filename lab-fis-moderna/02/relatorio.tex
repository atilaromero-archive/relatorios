...
Na figura \ref{figh1}, foram comparados luminosidade e temperatura. A regressão linear obtida informa a inclinação $\beta$, usada para o cálculo de $h$.
...
\begin{figure}[htbp!]
  \caption{Regressão polinomial para valores até 0,650 volts.}
  \label{figiniciopeq2}
  \centering
    %\includegraphics[scale=0.75]{iniciopeq.jpg}
...
\begin{figure}[htbp!]
  \caption{Regressão linar para os logaritmos dos valores medidos a partir de 2,60 volts.}
  \label{figfimpeq2}
  \centering
    %\includegraphics{fimpeq.eps}
    %\includegraphics[scale=0.75]{fimpeq.jpg}
...
Na figura \ref{figh2}, foram comparados luminosidade e temperatura. A regressão linear obtida informa a inclinação $\beta$, usada para o cálculo de $h$.
