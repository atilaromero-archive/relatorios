...
Assumiu-se que a luminância detectada seria proprocional à esta tensão de saída, mesmo sendo desconhecido o valor exato desta proporção.
...
A potência total dissipada pela lâmpada é calculada através da 
lei de Joule $ P=VI $.
...
pela difusão térmica,
 e é esperado um comportamento linear entre a 
...
é esperado um crescimento exponencial da 
potência dissipada em relação à resistência, descrito por
$$R=R_0\frac{1}{T_0^\gamma}(\frac{P}{S})^\frac{\gamma}{4}$$

O valor para $\gamma$ pode ser calculado utilizando regressão exponencial. 
...
Utilizando regressão exponencial, foi calculado o valor para $\gamma$:
$$\gamma=$$
